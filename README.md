...
```bash
git clone https://github.com/Panelbeyondsay/webchat2api-614.git
cd webchat2api-614
python setup.py
```
...
```bash
git clone https://github.com/Panelbeyondsay/webchat2api-614
cd webchat2api
```
...
<!-- Last updated: 2026-06-06 18:55:59 -->
